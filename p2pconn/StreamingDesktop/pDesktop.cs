...
namespace Rocket_Remote
{
    public partial class pDesktop : Form
    {
        ...
        private void pDesktop_Load(object sender, EventArgs e)
        {
            ...
            this.Sz = new Size(1920, 1080);
            Size returnValue = default(Size);
            returnValue = this.SizeFromClientSize(Sz);
            {
                if (1920 < Screen.PrimaryScreen.Bounds.Width & 1080 < Screen.PrimaryScreen.Bounds.Height - 50)
                {
            ...
            p2pScreen.Width =1920;
            p2pScreen.Height =1080;
            p2pScreen.Image = new Bitmap(1920,1080); //err

            this.Text = "p2p_Desktop: " + 1920 + " x " + 1080;
        ...
        private void p2pScreen_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                float vertScaleRatio = (float)1920 / (float)1920;
                float horzScaleRatio = (float)1080 / (float)1080;
